#!/usr/bin/env python3
"""DE 8주차 문제지 v2 (2026-05-09 개정) — Q7·Q8 spark-submit 강제 + 본인 증빙(Q6 print, Q9 HTML) + Q9·Q10 date && hostname 캡처"""
...
def build():
    ...
    story += [
        ...
        Paragraph("<b>v2 (2026-05-09 개정)</b>  —  Q7·Q8 spark-submit 강제 / 본인 증빙 강화", S["subtitle"]),
        sp(2),
    ...
    story += q(
        ...
        [
            ...
            "Q6/capture/s3_objects.png  —  AWS S3 콘솔에서 저장된 6개 객체 캡처",
        ],
        [
            ...
            "<b>(v2)</b> 수집 task 첫 줄 collector={본인이름} print 출력 (코드 또는 Task 로그 캡처에서 본인 이름 노출 필수)",
        ],
        images=[
    ...
    story += q(
        ...
        [
            ...
            "<b>(v2) Spark Job 실행은 SparkSubmitOperator 또는 BashOperator + spark-submit 으로 호출 (PythonOperator + python 실행 금지)</b>",
        ...
        [
            "ExternalTaskSensor",
            "<b>(v2) SparkSubmitOperator 또는 BashOperator + spark-submit 사용 (PythonOperator + python 실행 → X)</b>",
    ...
    story += q(
        ...
        [
            ...
            "<b>(v2) ConfigMap index.html 본문에 본인 이름·기수·Q8 결과 요약 포함 (browser.png 화면에 가시 노출 필수)</b>",
            "<b>(v2) capture/instance_id.png · capture/kubectl_get_all.png 캡처 상단에 `date && hostname` 출력 동봉 (LLM 원샷 방어)</b>",
        ],
    ...
    story += q(
        ...
        [
            ...
            "<b>(v2) 위 3개 캡처 상단에 `date && hostname` 출력 동봉 (LLM 원샷 방어)</b>",
        ],
